...
import { newStudentFormSchema, newStuffFormSchema, parseStringify } from "@/lib/utils";
    ...
    <div className="flex flex-col gap-4">
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction className="bg-orange-200 hover:bg-orange-300 " onClick={handleConfirmAddStuff}>
            Confirm
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className="grid grid-cols-2 gap-6 bg-orange-50 rounded-lg p-5">
              <div>
                ...
                <h1 className="pt-5">Add Stuff</h1>
              </div>
